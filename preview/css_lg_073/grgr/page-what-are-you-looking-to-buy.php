<?php
/**
 * Template Name: Page buyers form
 */
global $dgtForms;
...
<script>$('body').addClass('homeWorthPage'); </script>
<div class="full-form form-whats-my-property-work looking-to-buy">
  <?php  echo $dgtForms->loadGF(2, ['header' => false, 'title'=>false]); ?>
</div>
